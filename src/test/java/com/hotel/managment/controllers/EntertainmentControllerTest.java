...
public class EntertainmentControllerTest {
  ...
  public void getTypes() throws Exception {
    mockMvc
        .perform(get("/api/v1/entertainment/getTypes"))
  ...
  public void getAvailableElementsOccupied() throws Exception {
    mockMvc
        .perform(get("/api/v1/entertainment/getElements/Tennis/2028-10-10/08-00/2028-10-10/12-00"))
        .andExpect(status().isOk())
  ...
  public void getAvailableElementsFree() throws Exception {
    mockMvc
        .perform(get("/api/v1/entertainment/getElements/Tennis/2028-11-10/08-00/2028-11-10/12-00"))
        .andExpect(status().isOk())
  ...
  public void updatePrice() throws Exception {
    String json =
        "[" + "{" + "\"id\": 1, " + "\"name\": \"Tennis\", " + "\"price\": 50" + "}" + "]";
    mockMvc
        .perform(
            patch("/api/v1/entertainment/update-price")
