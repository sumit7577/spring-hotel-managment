...
public class BookingControllerTest {
    ...
    private void setupTestRoom() {
        ...
        RoomReservation roomReservation = new RoomReservation(Date.valueOf("2028-10-10"), Date.valueOf("2028-10-12"), new Timestamp(System.currentTimeMillis()), room1, testUser);
    ...
    private void setupTestEntertainment() {
        ...
        EntertainmentReservation entertainmentReservation = new EntertainmentReservation(timestampFrom, timestampTo, new Timestamp(System.currentTimeMillis()), testUser, entertainment1);
    ...
    public void bookRoomByAdmin() throws Exception {
        setupTestRoom();
        mockMvc.perform(get("/api/v1/bookings/room-by-admin/2028-09-05/2028-09-06/1/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.payment", is(nullValue())))
                .andExpect(jsonPath("$.data.fromDate", is("2028-09-05")))
                .andExpect(jsonPath("$.data.toDate", is("2028-09-06")))
    ...
    public void bookEntertainment() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/bookings/entertainment/Tennis/2028-09-05/2028-09-06/17-00/18-00/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.payment", is(nullValue())))
    ...
    public void getLastBooking() throws Exception {
        setupTestRoom();
        mockMvc.perform(get("/api/v1/bookings/room/getLastBooking"))
                .andExpect(status().isOk())
    ...
    public void getBookingsForPeriod() throws Exception {
        setupTestRoom();
        mockMvc.perform(get("/api/v1/bookings/room/getBookingsForPeriod/2028-10-09/2028-10-11"))
                .andExpect(status().isOk())
    ...
    public void getEntertainmentBookingsForPeriod() throws Exception {
        setupTestEntertainment();
        mockMvc.perform(get("/api/v1/bookings/getEntertainmentBookingsForPeriod/2028-10-09/2028-10-11"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(1)))
                .andExpect(jsonPath("$.data[0].clientName", is("test test")))
    ...
    public void getAllCurrentRooms() throws Exception {
        setupTestRoom();
        mockMvc.perform(get("/api/v1/bookings/room/getAllCurrentRooms"))
                .andExpect(status().isOk())
    ...
    public void getAll() throws Exception {
        setupTestRoom();
        setupTestEntertainment();
        mockMvc.perform(get("/api/v1/bookings/getAll"))
                .andExpect(status().isOk())
    ...
    public void getAllByAdmin() throws Exception {
        setupTestRoom();
        setupTestEntertainment();
        mockMvc.perform(get("/api/v1/bookings/getAllByAdmin/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(2)));
    }
    ...
    public void deleteBooking() throws Exception {
        setupTestRoom();
        mockMvc.perform(delete("/api/v1/bookings/deleteBooking/1"))
                .andExpect(status().isOk());
    ...
    public void deleteBookingByAdmin() throws Exception {
        setupTestRoom();
        mockMvc.perform(delete("/api/v1/bookings/deleteBookingByAdmin/1"))
                .andExpect(status().isOk());
        assertEquals(0, roomReservationRepository.findAll().size());
    }
    ...
    public void deleteEntertainmentBooking() throws Exception {
        setupTestEntertainment();
        mockMvc.perform(delete("/api/v1/bookings/deleteEntertainmentBooking/1"))
                .andExpect(status().isOk());
    ...
    public void deleteEntertainmentBookingByAdmin() throws Exception {
        setupTestEntertainment();
        mockMvc.perform(delete("/api/v1/bookings/deleteEntertainmentBookingByAdmin/1"))
                .andExpect(status().isOk());
        assertEquals(0, entertainmentReservationRepository.findAll().size());
    }
