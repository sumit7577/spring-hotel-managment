...
public class MenuControllerTest {
    ...
    public void setup() {
        ...
        MenuType menuType1 = new MenuType(MenuType.EMenu.BREAKFAST);
        MenuType menuType2 = new MenuType(MenuType.EMenu.LUNCH);
        MenuType menuType3 = new MenuType(MenuType.EMenu.DINNER);
    ...
    public void getDishes() throws Exception {
        mockMvc.perform(get("/api/v1/menu/getDishes"))
    ...
    public void getBreakfast() throws Exception {
        mockMvc.perform(get("/api/v1/menu/getBreakfast"))
                .andExpect(status().isOk())
    ...
    public void getLunch() throws Exception {
        mockMvc.perform(get("/api/v1/menu/getLunch"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(0)));
    }
    ...
    public void getDinner() throws Exception {
        mockMvc.perform(get("/api/v1/menu/getDinner"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(0)));
    }
    ...
    public void getMenuForDay() throws Exception {
        mockMvc.perform(get("/api/v1/menu/getMenuForDay/2028-10-12"))
                .andExpect(status().isOk())
    ...
    public void deleteFromDayMenu() throws Exception {
        mockMvc.perform(delete("/api/v1/menu/deleteFromDayMenu/2028-10-12/1/BREAKFAST"))
                .andExpect(status().isOk());
    ...
    public void addDishToTheDayMenu() throws Exception {
        MenuAddRequest menuAddRequest = MenuAddRequest.builder()
                .id(1)
                .date("2028-10-12")
                .menuTypeName(MenuType.EMenu.BREAKFAST)
                .build();

        mockMvc.perform(post("/api/v1/menu/addDishToTheDayMenu")
    ...
    public void addDish() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/menu/addDish")
                        .contentType("application/json")
    ...
    public void deleteDish() throws Exception {
        mockMvc.perform(delete("/api/v1/menu/deleteDish/1"))
                .andExpect(status().isOk());
    ...
    public void updateDish() throws Exception {
        Dish dish = new Dish("Dish4", "Description4", "PhotoDirectory4");
        mockMvc.perform(put("/api/v1/menu/updateDish/1")
                        .contentType("application/json")
                        .content(objectMapper.writeValueAsString(dish)))
                .andExpect(status().isOk());
