...
public class RoomControllerTest {
    ...
    public void setup() {
        ...
        RoomReservation roomReservation = new RoomReservation(Date.valueOf("2028-10-10"), Date.valueOf("2028-10-12"), new Timestamp(System.currentTimeMillis()), room1, user);
        roomReservationRepository.save(roomReservation);
    }

    @Test
    public void getById() throws Exception {
        mockMvc.perform(get("/api/v1/room/get/1"))
    ...
    public void delete() throws Exception {
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.delete("/api/v1/room/delete/1")
                        .contentType("application/json"))
                .andExpect(status().isOk());
    ...
    public void getAll() throws Exception {
        mockMvc.perform(get("/api/v1/room/getAll"))
                .andExpect(status().isOk())
    ...
    public void getRoomAvailabilityFalse() throws Exception {
        mockMvc.perform(get("/api/v1/room/room-available/1/2028-10-10/2028-10-12"))
                .andExpect(status().isOk())
    ...
    public void getRoomAvailabilityTrue() throws Exception {
        mockMvc.perform(get("/api/v1/room/room-available/1/2028-10-15/2028-10-18"))
                .andExpect(status().isOk())
    ...
    public void getAllByAvailableTimeAndTypeNotOccupied() throws Exception {
        mockMvc.perform(get("/api/v1/room/available/2028-10-15/2028-10-18/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(5)));
    }
    ...
    public void getAllByAvailableTimeAndTypeOccupied() throws Exception {
        mockMvc.perform(get("/api/v1/room/available/2028-10-10/2028-10-12/1"))
                .andExpect(status().isOk())
    ...
    public void getAllRoomTypes() throws Exception {
        mockMvc.perform(get("/api/v1/room/all-room-type"))
                .andExpect(status().isOk())
    ...
    public void getAllRoomTypesByAvailabilityAndOccupancy() throws Exception {
        mockMvc.perform(get("/api/v1/room/available-room-type/2028-10-15/2028-10-18/3"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(1)));
    }
    ...
    public void getAllRoomTypesByAvailabilityAndOccupancyToBigOccupancy() throws Exception {
        mockMvc.perform(get("/api/v1/room/available-room-type/2028-10-15/2028-10-18/6"))
                .andExpect(status().isOk())
    ...
    public void getAllRoomByAvailabilityNotOccupied() throws Exception {
        mockMvc.perform(get("/api/v1/room/available-rooms/2028-10-15/2028-10-18"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(5)));
    }
    ...
    public void getAllRoomByAvailabilityOccupied() throws Exception {
        mockMvc.perform(get("/api/v1/room/available-rooms/2028-10-10/2028-10-12"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.length()", is(4)));
    }
    ...
    public void updatePrice() throws Exception {
        ...
        mockMvc.perform(patch("/api/v1/room/update-price")
                        .contentType("application/json")
