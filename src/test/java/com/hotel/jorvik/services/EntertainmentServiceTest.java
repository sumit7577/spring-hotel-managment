...
import com.hotel.jorvik.services.implementation.EntertainmentServiceImp;
...
public class EntertainmentServiceTest {
    ...
    @InjectMocks
    private EntertainmentServiceImp entertainmentService;
    @Mock
    ...
    void getAllEntertainmentElementsByAvailableDate() {
        ...
        when(entertainmentRepository.findAvailableEntertainmentsByTypeAndTime(
                1, dateTimeFrom, dateTimeTo)).thenReturn(expectedEntertainments);

        List<Entertainment> actualEntertainments = entertainmentService.getAllEntertainmentElementsByAvailableDate(
