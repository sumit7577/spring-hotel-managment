...
import com.hotel.jorvik.services.implementation.MenuServiceImp;
...
public class MenuServiceTest {
    ...
    void testGetBreakfastMenu() {
        when(dishRepository.findDishesByMenuTypeNameAndMenuDate(any(), any())).thenReturn(Arrays.asList(dish1, dish2));
    ...
    void testGetLunchMenu() {
        when(dishRepository.findDishesByMenuTypeNameAndMenuDate(any(), any())).thenReturn(List.of(dish1));
    ...
    void testAddDishToTheDayMenu() {
        MenuType menuType = new MenuType(MenuType.EMenu.BREAKFAST);
        ...
        menuService.addDishToTheDayMenu("2023-01-01", 1, MenuType.EMenu.BREAKFAST);
    ...
    void testGetMenuForDay() {
        MenuForDayResponse menuForDayResponse1 = new MenuForDayResponse(1, "Pancake", MenuType.EMenu.LUNCH);
        MenuForDayResponse menuForDayResponse2 = new MenuForDayResponse(2, "Fish", MenuType.EMenu.LUNCH);
        when(dishRepository.findDishesByMenuDate(any())).thenReturn(Arrays.asList(menuForDayResponse1, menuForDayResponse2));
    ...
    void testDeleteFromDayMenu() {
        ...
        menuService.deleteFromDayMenu("2023-01-01", 1, MenuType.EMenu.BREAKFAST);
    ...
    void testUpdateDish() {
        ...
        verify(dishRepository, times(1)).save(argThat(
                dish -> dish.getName().equals("New Pancake") &&
